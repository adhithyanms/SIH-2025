...
const BusMonitoring: React.FC = () => {
  ...
  const getFilteredBuses = () => {
    switch (filter) {
      ...
      case 'delayed':
        return buses.filter(bus => bus.estimatedArrival.includes('delayed'));
      default:
        return buses;
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <option value="delayed">Delayed ({buses.filter(b => b.estimatedArrival.includes('delayed')).length})</option>
          </select>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {filteredBuses.map((bus) => (
          <div key={bus.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
