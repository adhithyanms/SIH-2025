...
// import { Bus, Route } from '../../types/index';
...
//         console.log('Buses from backend:', busesData);
//         console.log('Routes from backend:', routesData);
...
//           const data = await response.json();
//           const locationName =
//             data.address?.road || data.display_name || 'Current Location';
//           setFromStop(locationName);
//         } catch (error) {
//           console.error('Error fetching location name:', error);
//           setFromStop('Current Location');
...
//         <p className="text-gray-600">Loading buses and routes...</p>
//       </div>
//     );
//   }

//   // =============================
//   // SHOW MAP VIEW IF A BUS IS SELECTED
//   // =============================
//   if (selectedBus) {
//     const bus = buses.find((b) => b.id === selectedBus);
//     const route = routes.find((r) => r.routeNumber === bus?.routeNumber);
...
//               Search by route number or journey stops
//             </p>
//           </div>
...
//         {/* Results Section */}
//         {searchResults.length > 0 ? (
//           <BusList buses={searchResults} onSelectBus={setSelectedBus} />
//         ) : routeNumber || (fromStop && toStop) ? (
//           <div className="bg-white rounded-2xl shadow-sm p-8 text-center">
//             <div className="text-gray-500 mb-4">
//               <Search className="w-16 h-16 mx-auto mb-4 opacity-50" />
...
//                         buses.some(
//                           (bus) =>
//                             bus.routeNumber === route.routeNumber && bus.isActive
//                         )
//                           ? 'bg-green-500'
//                           : 'bg-gray-300'
//                       }`}
